...
image = io.imread("Medical_images/image2.png")
...
df.to_csv("cell2_watershed_segmentation_analysis.csv", index=False)
...
df_rg.to_csv("cell2_region_growing_analysis.csv", index=False)
