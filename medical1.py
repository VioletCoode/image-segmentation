...
image = io.imread("Medical_images/image1.png")
...
df.to_csv("cell1_watershed_segmentation_analysis.csv", index=False)
...
df_rg.to_csv("cell1_region_growing_analysis.csv", index=False)
