...
image = io.imread("Medical_images/image4.png")
...
df.to_csv("cell4_watershed_segmentation_analysis.csv", index=False)
...
df_rg.to_csv("cell4_region_growing_analysis.csv", index=False)
